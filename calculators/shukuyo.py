...
def calculate(person_a: dict, person_b: dict) -> dict:
    ...
    # アドバイス
    advice_map = {
        5: "宿曜占術で最高の相性です。前世からの深い縁で結ばれた関係を大切にしてください。",
        4: "宿曜占術でとても良い相性です。互いに良い影響を与え合える関係です。",
        3: "宿曜占術でバランスの取れた相性です。お互いの宿の特性を理解することで関係が深まります。",
        2: "宿曜占術ではやや注意が必要な相性ですが、学びの多い関係です。",
        1: "宿曜占術では試練の多い相性ですが、大きな成長と気づきをもたらします。",
    }
